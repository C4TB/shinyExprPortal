...
It is also possible to use the [{fst}](https://cran.r-project.org/web/packages/fst/index.html) and [{qs}](https://cran.r-project.org/web/packages/qs/index.html) packages for compressed data files. If using any of these packages, use .fst or .qs as file extensions.
