...
It is also possible to use the [{fst}](https://CRAN.R-project.org/package=fst) and [{qs}](https://CRAN.R-project.org/package=qs) packages for compressed data files. If using any of these packages, use .fst or .qs as file extensions.
